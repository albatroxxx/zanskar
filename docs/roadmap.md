...
Release-prep for v1.0.0 (single instance):
...
- [x] Install / configuration path — `zanskar init` writes the env file (#13, ADR 0014).
...
- [ ] Docs-only install validation on a clean VM.
- [ ] Tag v1.0.0.
